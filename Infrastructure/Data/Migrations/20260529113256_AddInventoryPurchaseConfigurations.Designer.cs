...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20260529113256_AddInventoryPurchaseConfigurations")]
    partial class AddInventoryPurchaseConfigurations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.ClienteCorreo", b =>
                {
                    ...
                    b.ToTable("ClienteCorreos", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.ClienteDireccion", b =>
                {
                    ...
                    b.ToTable("ClienteDirecciones", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.ClienteTelefono", b =>
                {
                    ...
                    b.HasIndex("ClienteId", "Telefono")
                        .IsUnique();

                    b.ToTable("ClienteTelefonos", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.DetalleCompra", b =>
                {
                    ...
                    b.HasIndex("CompraId", "RepuestoId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.HistorialEstadoOrden", b =>
                {
                    ...
                    b.HasIndex("OrdenId", "FechaCambio");
            ...
            modelBuilder.Entity("Domain.Entities.LogInventario", b =>
                {
                    ...
                    b.HasIndex("RepuestoId", "Fecha");

                    b.ToTable("LogsInventario", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.NotaOrden", b =>
                {
                    ...
                    b.ToTable("NotasOrden", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.OrdenMecanico", b =>
                {
                    ...
                    b.HasIndex("OrdenId", "MecanicoId")
                        .IsUnique();

                    b.ToTable("OrdenesMecanicos", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.OrdenTipoServicio", b =>
                {
                    ...
                    b.HasIndex("OrdenId", "TipoServicioId")
                        .IsUnique();

                    b.ToTable("OrdenesTiposServicio", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.RepuestoProveedor", b =>
                {
                    ...
                    b.HasIndex("RepuestoId", "ProveedorId")
                        .IsUnique();

                    b.ToTable("RepuestosProveedor", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.TareaMecanico", b =>
                {
                    ...
                    b.ToTable("TareasMecanicos", (string)null);
                });
